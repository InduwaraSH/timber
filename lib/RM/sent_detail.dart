...
class ARM_SentDetail extends StatefulWidget {
  final String poc;
  ...
  @override
  State<ARM_SentDetail> createState() => _ARM_SentDetailState();
}

class _ARM_SentDetailState extends State<ARM_SentDetail> {
  @override
