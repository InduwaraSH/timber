...
class RmSentViewRejByRm extends StatefulWidget {
  final String poc;
  ...
  @override
  State<RmSentViewRejByRm> createState() => _RmSentViewRejByRmState();
}

class _RmSentViewRejByRmState extends State<RmSentViewRejByRm> {
  late Query dbref;
