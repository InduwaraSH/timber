...
class RmRegister extends StatefulWidget {
  const RmRegister({super.key});

  @override
  State<RmRegister> createState() => _RmRegisterState();
}

class _RmRegisterState extends State<RmRegister> {
  int _selectedTown = 0;
