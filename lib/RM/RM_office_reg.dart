...
class RmOfficeRegister extends StatefulWidget {
  ...
  @override
  State<RmOfficeRegister> createState() => _RmOfficeRegisterState();
}

class _RmOfficeRegisterState extends State<RmOfficeRegister> {
  int _selectedTown = 0;
                        ...
                        onPressed: () async {
                          if (idController.text.isEmpty ||
                            ...
                            Map<String, String> branchData = {
                              ...
                              "branchLocation": _townName[_selectedTown]
                                  .toString(),
                            };
                            branchReference
