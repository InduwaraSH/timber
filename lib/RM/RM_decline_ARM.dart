...
class RM_Decline extends StatefulWidget {
  final String office;
  ...
  @override
  State<RM_Decline> createState() => _RM_DeclineState();
}

class _RM_DeclineState extends State<RM_Decline> {
            ...
            showCupertinoDialog(
              ...
              builder: (BuildContext dialogContext) {
                return CupertinoAlertDialog(
                  ...
                  content: Text(
                    'Once you press Reject, this document will be marked as Rejected and forwarded to the relevant ARM, along with your rejection reason.',
                    style: TextStyle(
