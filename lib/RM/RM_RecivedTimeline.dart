...
class RmRecivedtimeline extends StatefulWidget {
  final String branchName;
  final String poc;

  final String SerialNum;

  const RmRecivedtimeline({
    super.key,
  ...
  @override
  State<RmRecivedtimeline> createState() => _RmRecivedtimelineState();
}

class _RmRecivedtimelineState extends State<RmRecivedtimeline> {
