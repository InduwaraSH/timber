...
class RmSentviewNotapprove extends StatefulWidget {
  final String poc;
  ...
  @override
  State<RmSentviewNotapprove> createState() => _RmSentviewNotapproveState();
}

class _RmSentviewNotapproveState extends State<RmSentviewNotapprove> {
  late Query dbref;
