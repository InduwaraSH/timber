...
class RmSentviewApprove extends StatefulWidget {
  final String poc;
  ...
  @override
  State<RmSentviewApprove> createState() => _RmSentviewApproveState();
}

class _RmSentviewApproveState extends State<RmSentviewApprove> {
  late Query dbref;
