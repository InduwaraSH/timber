...
class ARmRecivedViewRejByRm extends StatefulWidget {
  final String poc;
  ...
  @override
  State<ARmRecivedViewRejByRm> createState() =>
      _aRmRecivedView_ADGMState_Rejected();
}

class _aRmRecivedView_ADGMState_Rejected extends State<ARmRecivedViewRejByRm> {
