...
class DGM_Sent_approved_view extends StatefulWidget {
  final String poc;
  ...
  @override
  State<DGM_Sent_approved_view> createState() => _DGM_Sent_approved_viewState();
}

class _DGM_Sent_approved_viewState extends State<DGM_Sent_approved_view> {
  late Query dbref;
