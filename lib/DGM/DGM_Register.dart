...
class DgmRegister extends StatefulWidget {
  const DgmRegister({super.key});

  @override
  State<DgmRegister> createState() => _DgmRegisterState();
}

class _DgmRegisterState extends State<DgmRegister> {
  //int _selectedTown = 0;
