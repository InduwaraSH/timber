...
class dgm_b_navbar extends StatefulWidget {
  ...
  @override
  State<dgm_b_navbar> createState() => _dgm_b_navbarState();
}

class _dgm_b_navbarState extends State<dgm_b_navbar> {
  late final DGMNavigControll controller;
  bool _isNavVisible = true;

  @override
  void initState() {
    super.initState();
    Get.delete<DGMNavigControll>();
    controller = Get.put(
      DGMNavigControll(widget.office_location, widget.username),
    );
  }

  /// Attach scroll detection to screen
...
class DGMNavigControll extends GetxController {
