...
class AGM_Sent_approved_view extends StatefulWidget {
  final String poc;
  ...
  @override
  State<AGM_Sent_approved_view> createState() => _AGM_Sent_approved_viewState();
}

class _AGM_Sent_approved_viewState extends State<AGM_Sent_approved_view> {
  late Query dbref;
