...
class _agm_b_navbarState extends State<agm_b_navbar> {
  late final AGMNavigControll controller;
  bool _isNavVisible = true;

  @override
  void initState() {
    super.initState();
    Get.delete<AGMNavigControll>();
    controller = Get.put(
      AGMNavigControll(widget.office_location, widget.username),
    );
  }
      ...
      () => Scaffold(
        ...
        body: Stack(
          children: [
            ...
            // Floating glass-style navigation bar
            Positioned(
              left: 18,
              right: 18,
              bottom: 20,
...
class AGMNavigControll extends GetxController {
  final Rx<int> selectedIndex = 0.obs;
  final String office_location;
  final String username;

  AGMNavigControll(this.office_location, this.username);
