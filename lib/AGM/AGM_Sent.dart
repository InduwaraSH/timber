...
class AgmSent extends StatefulWidget {
  ...
  @override
  State<AgmSent> createState() => _AgmSentState();
}

class _AgmSentState extends State<AgmSent> {
  late Query dbref;
      ...
      onPressed: () {
        if (check == "AGM_APPROVED") {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => AGM_Sent_approved_view(
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => AGM_Sent_rejected_view(
                ARM_Branch_Name: branchName,
                poc: poc,
                DateInformed: DateInformed,
                LetterNo: LetterNo,
